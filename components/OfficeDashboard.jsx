    ...
    <div className="page-transition p-6 space-y-8">
      ...
      <div className="card-modern p-8">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-text-primary mb-2">Quick Actions</h2>
          <p className="text-text-secondary">Get started with common tasks</p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link href="/office/quotations/new" className="group">
            <div className="p-6 rounded-xl bg-gradient-to-br from-primary/10 to-primary/20 border border-primary/30 hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-primary/20 to-primary/30 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-text-primary mb-2">New Quote</h3>
              <p className="text-text-secondary text-sm">Create a new quotation for a client</p>
            </div>
          </Link>

          <Link href="/office/jobs/new" className="group">
            <div className="p-6 rounded-xl bg-gradient-to-br from-success/10 to-success/20 border border-success/30 hover:border-success/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-success/20 to-success/30 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-success" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-text-primary mb-2">New Job</h3>
              <p className="text-text-secondary text-sm">Create a new job assignment</p>
            </div>
          </Link>

          <Link href="/office/epos" className="group">
            <div className="p-6 rounded-xl bg-gradient-to-br from-accent/10 to-accent/20 border border-accent/30 hover:border-accent/50 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-accent/20 to-accent/30 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-text-primary mb-2">EPOS</h3>
              <p className="text-text-secondary text-sm">Access the electronic point of sale system</p>
            </div>
          </Link>
        </div>
      </div>
      ...
      {/* Vehicle Overview and Job Status Side by Side */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <CardContent>
          {todayJobs.length === 0 ? (
            ...
            <div className="space-y-3">
              {todayJobs.map((job) => (
                <Link key={job.id} href={`/office/jobs/${job.id}`} className="block">
                  <div className="flex items-center justify-between p-4 bg-surface-secondary rounded-lg border border-border-primary/50 hover:border-border-accent transition-all duration-200 hover:bg-surface-tertiary">
